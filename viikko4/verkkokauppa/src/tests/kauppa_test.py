...
class TestKauppa(unittest.TestCase):
    ...
    def test_yritä_ostaa_kaksituotetta_joista_toinen_on_loppu(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_aloita_asiointi_uudelleen(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_viite_pyydetään_aina(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_poista_korista_vaikka_siellä_ei_ollut_mitään(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.poista_korista(1)
        self.kauppa.tilimaksu("pekka", "12345")
